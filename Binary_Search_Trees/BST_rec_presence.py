#Tests for the presence of an element in a BST recursively.
...
class BST:
    ...
    def rec_is_present(self, ptr, thingy):
        if ptr == None:
            ...
            return self.rec_is_present(ptr.left, thingy) or self.rec_is_present(ptr.right, thingy)

    def is_present(self, thingy):
        return self.rec_is_present(self.root, thingy)
